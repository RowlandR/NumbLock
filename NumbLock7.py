...
def RunLvl(LvlInd, LvlMode, ActUser): #What lvl (Freestyle, Missed, or Lvl-%) ||| Relaxed or Timed Mode ||| What user is active (for recording score purposes)
    ...
    while True:
        ...
        if Answer1 != 'x': #x means that the operation called upon did not work
            ...
            try: #attepmts to see if Answer2 is actually an int, if not, then it will look for other command prompts or false input
                Answer2 = int(Answer2)
                if Answer2 == Answer1:
                    print('Correct!')
                else:
                ...
                if Answer2.lower() == "skip":
                    pass
                elif Answer2.lower() == "end":
                    break
                else:
                    print("Wrong input")
